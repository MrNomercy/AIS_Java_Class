...
public class SILVER extends MEMBER //inheritance
{
	...
	public void mysilver() 
	{
		...
		mymem.displayreceipt(prolist,prilist,customer_count,10,member);
		mymem.printreceipt(prolist, prilist,customer_count,10,member);
		//end of while loop
