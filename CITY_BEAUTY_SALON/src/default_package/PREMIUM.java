...
public class PREMIUM extends MEMBER //inheritance
{
	...
	public void mypremium() 
	{
		...
		mymem.displayreceipt(prolist,prilist,customer_count,20,member);
		mymem.printreceipt(prolist, prilist,customer_count,20,member);
		//end of while loop
